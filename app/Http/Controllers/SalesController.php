    ...
    public function index(Request $request)
{
    ...
    while ($currentDate <= $endDate) {
        ...
        // If we have sales for this date, use that value, otherwise use 0
        if (isset($dailySales[$dateString])) {
            $salesData[] = $dailySales[$dateString]->total;
        } else {
            $salesData[] = 0;
        }
